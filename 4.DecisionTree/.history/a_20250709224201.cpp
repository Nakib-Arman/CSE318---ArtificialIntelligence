...
float getInformationGain(vector<vector<string>>& dataset, vector<unordered_map<string,int>>& values, int attribute_num,float threshold=0)
{
...
int main()
{
    ...
    cout<<getEntropy(dataset,values[values.size()-1])<<endl;
