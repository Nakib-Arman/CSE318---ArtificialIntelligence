...
float getInformationGain(vector<vector<string>>& dataset, unordered_set<string>& decisions, string attribute, unordered_set<string>)
...
int main()
{
    ...
    float entropy = getEntropy(dataset,values[values.size()-1]);
    cout<<entropy<<endl;
    return 0;
}