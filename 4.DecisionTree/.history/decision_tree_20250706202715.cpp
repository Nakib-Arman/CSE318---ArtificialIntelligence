...
Node* makeDecisionTree(vector<vector<string>>& dataset, vector<pair<int,bool>>& attributes, vector<unordered_set<string>>& values, vector<float)
{   
    ...
    for(string val: values[max_i]){
        if(is_digit(val)){
            ...
            vector<float> numeric_values1,numeric_values2;
            for(int i=0;i<dataset.size();i++){
            ...
            //     for(int j=0;j<temp_dataset1[0].size();j++){
            //         cout<<temp_dataset1[i][j]<<" ";
            //     }
            //     cout<<endl;
            // }
            // for(int i=0;i<temp_dataset2.size();i++){
            //     for(int j=0;j<temp_dataset2[0].size();j++){
            //         cout<<temp_dataset2[i][j]<<" ";
            //     }
            //     cout<<endl;
            // }
            int max=0;
            ...
            if(temp_dataset2.size() == 0){
                ...
                Node* child2 = makeDecisionTree(temp_dataset2,attributes,values);
