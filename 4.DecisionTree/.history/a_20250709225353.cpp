...
float getInformationGain(vector<vector<string>>& dataset, vector<unordered_map<string,int>>& values, unordered_map<string,int>& decisions,int attribute_num,float threshold=0)
{
