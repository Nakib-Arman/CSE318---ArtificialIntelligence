...
float getInformationGain(vector<vector<string>>& dataset, vector<unordered_set<string,int>>& values, unordered_map<string,int>& decisions,int attribute_num,float threshold=0)
{
...
int main()
{
    ...
    cout<<getEntropy(dataset,decisions)<<endl;
