...
# grid setup
rows, cols = 9, 6
cell_x, cell_y = (screen_x-800) // cols, (screen_y-100) // rows
    ...
    for i,row in enumerate(counts):
        for j,value in enumerate(row):
            ...
            if value == 3:
                ...
                pygame.draw.circle(screen, colors[i][j], ((orb_position_x + cell_x // 2 + orb_radius - orb_radius // 3),(orb_position_y+cell_y // 2 + orb_radius - orb_radius // 3)),orb_radius)
                pygame.draw.circle(screen, borders[i][j], ((orb_position_x + cell_x // 2 + orb_radius - orb_radius // 3),(orb_position_y+cell_ // 2 + orb_radius - orb_radius // 3)),orb_radius,1)
