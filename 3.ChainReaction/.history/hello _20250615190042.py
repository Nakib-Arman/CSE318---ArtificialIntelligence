...
def ai_vs_ai_menu():
    ...
    heuristics = [
        "Controlled Cell Difference","Orb Count Difference","Controlled Edge Cell Difference","Edge Cell Orb Count Difference","Critical Mass Proximity"
    ]
    
    ai1_option = heuristics[1]  # Default for AI1
    ai2_option = heuristics[1]  # Default for AI2
    ...
    while running:
                ...
                # Check AI1 option click
                    ...
                    for i, option in enumerate(heuristics):
                        ...
                        if option_rect.collidepoint(mx, my):
                            ai1_option = option
                            ai1_dropdown_open = False
                            print("AI1 selected:", ai1_option)
                            break
                    else:
                        ai1_dropdown_open = False

                # Check AI2 option click
        ...
        # Draw AI2 dropdown options
        if ai2_dropdown_open:
            for i, option in enumerate(heuristics):
                option_rect = pygame.Rect(ai2_rect.x, ai2_rect.y + (i+1)*option_height, ai2_rect.width, option_height)
                pygame.draw.rect(screen, (255, 255, 255), option_rect)
                pygame.draw.rect(screen, (0, 0, 0), option_rect, 1)
