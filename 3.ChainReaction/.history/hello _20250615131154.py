...
def settings_menu():
    ...
    grid_size = pygame.Rect(screen_x // 2 - 150, screen_y // 2 - 120, 300, 650)
    quit_rect = pygame.Rect(screen_x // 2 - 150, screen_y // 2 - 40, 300, 60)
    ...
    while True:
        ...
        # screen.blit(text, text.get_rect(center=(screen_x // 2, screen_y // 2 - 100)))

        # Buttons
        pygame.draw.rect(screen, (0, 128, 0), grid_size)
        pygame.draw.rect(screen, (128, 0, 0), quit_rect)

        play_text = button_font.render("Play Again", True, (255, 255, 255))
        quit_text = button_font.render("Quit", True, (255, 255, 255))

        screen.blit(play_text, play_text.get_rect(center=grid_size.center))
