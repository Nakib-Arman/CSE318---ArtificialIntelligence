...
def game_over():
    ...
    close_btn = pygame.Rect(popup_x + popup_width - 40, popup_y + 10, 30, 30)  # top-right corner

    showing_popup = True
    while showing_popup:
        # Keep showing the final game state
        load_ui()
        ...
        screen.blit(x_text, x_text.get_rect(center=close_btn.center))
        ...
        msg_rect = msg_text.get_rect(center=(screen_x // 2, popup_y + 120))
