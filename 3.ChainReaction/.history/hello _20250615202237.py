...
def ai_vs_ai_menu():
    ...
    play_button = pygame.Rect((screen_x // 2) - 75, screen_y - 100, 150, 50)
    play_button_text = pygame.font.SysFont(None, 30).render("Play", True, (255,))
    back_button = pygame.Rect(20, 20, 130, 40)
    back_text = pygame.font.SysFont(None, 30).render("Back", True, (255, 255, 255))
    ...
    while running:
        ...
        screen.blit(play_text, play_text.get_rect(center=play_button_rect))
