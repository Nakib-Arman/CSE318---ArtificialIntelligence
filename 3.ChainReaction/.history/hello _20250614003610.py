    ...
    for i,row in enumerate(counts):
        for j,value in enumerate(row):
            ...
            if value == 0:
                continue
            if value == 1:
                pygame.draw.circle(screen, colors[i][j], ((orb_position_x),(orb_position_y+50)),orb_radius)
                pygame.draw.circle(screen, borders[i][j], ((orb_position_x),(orb_position_y+50)),orb_radius,1)
            if value == 3:
