...
while running:
    ...
    pygame.draw.circle(screen, user_color, ((grid_x + 30),(grid_y+50)),15)
    pygame.draw.circle(screen, user_color, ((grid_x + 50),(grid_y+50)),15)
    pygame.draw.circle(screen, user_color, ((grid_x + 30),(grid_y+30)),10)
