...
pair<int,pair<int,int>> minimax(vector<vector<Cell>>& grid,char ai_color,char user_color)

void getBestMove(vector<vector<Cell>>& grid,char ai_color,char user_color) {
