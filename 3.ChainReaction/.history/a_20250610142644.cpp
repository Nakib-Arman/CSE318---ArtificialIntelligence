...
int main()
{
    ...
    grid[0][1].set_orb_num(1);
    grid[0][2].set_orb_num(1);
    grid[0][3].set_orb_num(1);
    grid[0][4].set_orb_num(1);
    grid[0][5].set_orb_num(1);

    grid[1][0].set_orb_num(1);
    grid[1][1].set_orb_num(1);
    grid[1][2].set_orb_num(1);
    grid[1][3].set_orb_num(1);
    grid[1][4].set_orb_num(1);
    grid[1][5].set_orb_num(1);

    grid[2][0].set_orb_num(1);
    grid[2][1].set_orb_num(1);
    grid[2][2].set_orb_num(1);
    grid[2][3].set_orb_num(1);
    grid[2][4].set_orb_num(1);
    grid[2][5].set_orb_num(1);

    grid[3][0].set_orb_num(1);
    grid[3][1].set_orb_num(1);
    grid[3][2].set_orb_num(1);
    grid[3][3].set_orb_num(1);
    grid[3][4].set_orb_num(1);
    grid[3][5].set_orb_num(1);

    grid[4][0].set_orb_num(1);
    grid[4][1].set_orb_num(1);
    grid[4][2].set_orb_num(1);
    grid[4][3].set_orb_num(1);
    grid[4][4].set_orb_num(1);
    grid[4][5].set_orb_num(1);

    grid[5][0].set_orb_num(1);
    grid[5][1].set_orb_num(1);
    grid[5][2].set_orb_num(1);
    grid[5][3].set_orb_num(1);
    grid[5][4].set_orb_num(1);
    grid[5][5].set_orb_num(1);

    grid[6][0].set_orb_num(1);
    grid[6][1].set_orb_num(1);
    grid[6][2].set_orb_num(1);
    grid[6][3].set_orb_num(1);
    grid[6][4].set_orb_num(1);
    grid[6][5].set_orb_num(1);

    grid[7][0].set_orb_num(1);
    grid[7][1].set_orb_num(1);
    grid[7][2].set_orb_num(1);
    grid[7][3].set_orb_num(1);
    grid[7][4].set_orb_num(1);
    grid[7][5].set_orb_num(1);

    grid[8][0].set_orb_num(1);
    grid[8][1].set_orb_num(1);
    grid[8][2].set_orb_num(1);
    grid[8][3].set_orb_num(1);
