...
def game_over():
    ...
    play_again_rect = pygame.Rect(screen_x // 2 - 150, screen_y // 2, 300, 60)
    quit_rect = pygame.Rect(screen_x // 2 - 150, screen_y // 2 + 80, 300, 60)
    ...
    while True:
        ...
        # Buttons
        pygame.draw.rect(screen, (0, 128, 0), play_again_rect)
