...
while running:
    ...
    pygame.draw.circle(screen, (255,255,255), ((grid_x + 30),(grid_y+50)),12,1)
    pygame.draw.circle(screen, user_color, ((grid_x + 50),(grid_y+50)),12)
    pygame.draw.circle(screen, (255,255,255), ((grid_x + 50),(grid_y+50)),12,1)
    pygame.draw.circle(screen, user_color, ((grid_x + 40),(grid_y+30)),12)
    pygame.draw.circle(screen, (255,255,255), ((grid_x + 40),(grid_y+30)),12,1)
