...
def game_level_menu():
    ...
    heuristics = ["Controlled Cell Difference", "Orb Count Difference", "Edge Preferred Controlled Cell Difference", "Edge Cell Orb Count Difference", "Critical Mass Proximity"]
    depths = ["0", "1", "2", "3"]
