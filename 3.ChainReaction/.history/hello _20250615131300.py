...
def settings_menu():
    ...
    while True:
        ...
        pygame.draw.rect(screen, (128, 0, 0), color_rect)

        grid_size_text = button_font.render("Play Again", True, (255, 255, 255))
        color_text = button_font.render("Quit", True, (255, 255, 255))
