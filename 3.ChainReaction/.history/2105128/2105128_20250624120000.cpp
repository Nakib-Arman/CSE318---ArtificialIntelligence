...
pair<int,int> getBestMove(vector<vector<Cell>>& grid,char ai_color,char user_color,int depth,float (*func)(vector<vector<Cell>>&,char,int x,int y)) {
...
void aiMove(vector<vector<Cell>>& grid,char ai_color,char user_color,int depth,float (*func)(vector<vector<Cell>>&,char)) {
    pair<int,int> best_move = getBestMove(grid,ai_color,user_color,depth,func);
