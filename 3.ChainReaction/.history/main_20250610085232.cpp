...
int aiMove(vector<vector<Cell>>& grid,char ai_color,char user_color,int row,int column) {
    pair<int,pair<int,int>> best_move = getBestMove(grid,ai_color,user_color,)
}
