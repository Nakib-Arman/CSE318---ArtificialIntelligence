...
def grid_size_menu():
    ...
    grid_row = pygame.Rect(screen_x // 2 - 150, screen_y // 2 - 50, 300, 40)
    grid_col = pygame.Rect(screen_x // 2 - 150, screen_y // 2 + 10, 300, 40)

    while True:
        screen.fill((0, 0, 0, 180))
        screen.blit(background, (0, 0))

        pygame.draw.rect(screen, (0, 128, 0), grid_row_rect)
