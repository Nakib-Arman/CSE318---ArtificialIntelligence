    ...
    for i,row in enumerate(counts):
        for j,value in enumerate(row):
            ...
            if value == 3:
                ...
                pygame.draw.circle(screen, colors[i][j], ((orb_position_x + cell_x // 2),(orb_position_y+cell_x // 2 - orb_radius + orb_radius // 3)),orb_radius)
                pygame.draw.circle(screen, borders[i][j], ((orb_position_x + cell_x // 2),(orb_position_y+2*center_offset_y)),orb_radius,1)
