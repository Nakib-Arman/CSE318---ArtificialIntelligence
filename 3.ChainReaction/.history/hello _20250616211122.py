...
game_running = False
def load_ui():
    global rows,cols,cell_surface,grid_x,grid_y,cell_x,cell_y,start_time,game_running
    ...
    if game_running:
        ...
        timer_text = timer_font.render(f"Time: {time_str}", True, (255, 255, 255))
...
# game over menu
def game_over():
    global screen_x,screen_y,player1,player2,game_running
    screen.blit(background, (0, 0))
...
# AI vs AI gameplay
def play_ai_vs_ai():
    global player1,player2,winner,counts,colors,borders,rows,cols,heuristic1,heuristic2,depth1,depth2,start_time,game_running
...
def game_level_menu():
    ...
    heuristics = ["Controlled Cell Difference", "Orb Count Difference", "Edge Preferred Controlled Cell Difference", "Edge Preferre Orb Count Difference", "Critical Mass Proximity"]
    depths = ["0", "1", "2", "3"]
...
def ai_vs_ai_menu():
    ...
    heuristics = ["Controlled Cell Difference", "Orb Count Difference", "Edge Preferred Controlled Cell Difference", "Edge Preferred Orb Count Difference", "Critical Mass Proximity"]
    depths = ["0", "1", "2", "3"]
    ...
    while running:
        ...
        ai1_title = font.render("AI 1", True, (255, 0, 0))
        screen.blit(ai1_title, (ai1_rect.x + ai1_rect.width//2 - ai1_title.get_width()//2, ai1_rect.y - 40))
        ai2_title = font.render("AI 2", True, (255, 0, 0))
        screen.blit(ai2_title, (ai2_rect.x + ai2_rect.width//2 - ai2_title.get_width()//2, ai2_rect.y - 40))
