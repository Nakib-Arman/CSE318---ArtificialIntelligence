...
def grid_size_menu():
    ...
    while True:
        ...
        pygame.draw.rect(screen, (0, 128, 0), row_rect)
        row_text = button_font.render(f"Rows: {rows}", True, (255, 255, 255))
        row_text_rect = grid_size_text.get_rect(center=grid_size_rect.center)
...
def settings_menu():
    ...
    grid_size_rect = pygame.Rect(screen_x // 2 - 150, screen_y // 2 - 140, 300, 40)
    color_rect = pygame.Rect(screen_x // 2 - 150, screen_y // 2 - 80, 300, 40)
