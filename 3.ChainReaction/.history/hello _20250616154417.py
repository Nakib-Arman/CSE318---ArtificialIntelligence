...
def random_vs_ai_menu():
    ...
    randoms = ["Controlled Cell Difference", "Orb Count Difference", "Controlled Edge Cell Difference", "Edge Cell Orb Count Difference", "Critical Mass Proximity"]
    depths = ["0", "1", "2", "3"]
