...
options = ["3", "6", "9", "12", "15"]
selected_option = options[2]  # Default is "9"
dropdown_rect = pygame.Rect(150, 100, 100, 40)
option_height = 40
dropdown_open = False
...
def draw_dropdown():
    ...
    selected_text = font.render(selected_option, True, BLACK)
    screen.blit(selected_text, (dropdown_rect.x + 10, dropdown_rect.y + 5))
