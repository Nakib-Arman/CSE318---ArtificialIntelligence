...
def ai_vs_ai_menu():
    ...
    ai1_options = ["Controlled Cell Difference", "Orb Count Difference", "Controlled Edge Cell Difference", "Edge Cell Orb Count Difference", "Critical Mass Proximity"]
    selected_option = ai1_options[2]  
    ai1_rect = pygame.Rect(screen_x // 2 - 150, screen_y // 2 - 50, 300, 40)
    col_rect = pygame.Rect(screen_x // 2 - 150, screen_y // 2 + 10, 300, 40)
