...
while running:
    ...
    pygame.draw.circle(screen, user_color, ((grid_x + 30),(grid_y+50)),13)
    pygame.draw.circle(screen, (0,0,0), ((grid_x + 30),(grid_y+50)),13,1)
    pygame.draw.circle(screen, user_color, ((grid_x + 50),(grid_y+50)),13)
    pygame.draw.circle(screen, (0,0,0), ((grid_x + 50),(grid_y+50)),13,1)
    pygame.draw.circle(screen, user_color, ((grid_x + 40),(grid_y+30)),13)
    pygame.draw.circle(screen, (0,0,0), ((grid_x + 40),(grid_y+30)),13,1)
