...
static const flex_int16_t yy_base[22] =
    {   0,
        0,    0,   18,   19,    3,    0,    6,   13,    0,   13,
        9,    0,    0,    0,    0,    0,   12,   19,   12,   10,
        4
    } ;

static const flex_int16_t yy_def[22] =
    {   0,
       18,    1,   18,   18,   18,   19,   18,    5,    5,   19,
       18,   20,    7,    8,   11,   21,   21,    0,   18,   18,
       18
    } ;

static const flex_int16_t yy_nxt[24] =
    {   0,
        4,    5,    6,    7,    8,   17,    9,   11,   12,   13,
       11,   16,   15,   10,   12,   12,   14,   18,    3,   18,
       18,   18,   18
    } ;

static const flex_int16_t yy_chk[24] =
    {   0,
        1,    1,    1,    1,    5,   21,    5,    7,    7,    7,
       11,   20,   11,   19,   17,   10,    8,    3,   18,   18,
       18,   18,   18
    } ;
